...
Unix shell Thompson shell Ken Thompson Everything you need to know to start coding your own shell concept page
...
covering both regular tests and edge cases for each task. See task 8. Test suite.
